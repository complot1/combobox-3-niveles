...
<nav class="navbar navbar-default">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="./">ComboBox Anidados Ejemplo base del Peru</a>
    </div>
...
<?php foreach($countries as $c):?>
      <option value="<?php echo $c->idDepa; ?>"><?php echo $c->departamento; ?></option>
<?php endforeach; ?>
    </select>
  </div>
 ...
 <div class="panel-footer">ComboBox 3 Anidados</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#continente_id").change(function(){
			$.get("Paises.php","idDepa="+$("#continente_id").val(), function(data){
				$("#pais_id").html(data);
				console.log(data);
			});
		});
		...
		$("#pais_id").change(function(){
			$.get("Ciudades.php","idProv="+$("#pais_id").val(), function(data){
				$("#ciudad_id").html(data);
				console.log(data);
			});
		});
