...
$query=$db->query("select * from ubprovincia");
$states = array();
...
<?php foreach($countries as $c):?>
      <option value="<?php echo $c->idProv; ?>"><?php echo $c->provincia; ?></option>
<?php endforeach; ?>
    </select>
  </div>
...
<?php foreach($states as $c):?>
      <option value="<?php echo $c->idDist; ?>"><?php echo $c->distrito; ?></option>
<?php endforeach; ?>
    </select>
  </div>
